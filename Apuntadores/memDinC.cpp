...
int main(){
    ...
    if(p_data != NULL){                                     // Verificacion de reservacion
        ...
        free(p_data);                                       // Liberacion  de memoria
    }    


    p_data = (Data*) malloc(sizeof(Data)*10);               // Rservacion de memoria para un arreglo de 10 registros
    if(p_data != NULL){                                     // Verificacion de reservacion
        ...
        free(p_data);                                       // Liberacion de memoria del arreglo
    }
